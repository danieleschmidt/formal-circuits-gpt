...
class ResourceMonitor:
    ...
    def get_average_usage(self, duration_seconds: Optional[float] = None) -> ResourceUsage:
        ...
        return ResourceUsage(
            ...
            gpu_memory_percent=sum(u.gpu_memory_percent for u in history) / len(history),
...
class ResourceManager:
    ...
    def check_resource_limits(self) -> Dict[ResourceType, bool]:
        ...
        # Check Network
        total_network = current_usage.network_sent_mbps + current_usage.network_recv_mbps
    ...
    def _apply_throttling(self, violations: Dict[ResourceType, bool], usage: ResourceUsage):
    ...
    def get_resource_stats(self) -> Dict[str, Any]:
        ...
        current_usage = self.monitor.get_current_usage()
        average_usage = self.monitor.get_average_usage(duration_seconds=300)  # 5 minutes
