...
class HealthChecker:
    ...
    def get_overall_status(self, results: Dict[str, HealthCheck]) -> Tuple[HealthStatus, str]:
    ...
    def _check_theorem_provers(self) -> HealthCheck:
        ...
        try:
            ...
            metadata = {
                "isabelle_available": isabelle_ok,
                "coq_available": coq_ok
            }
    ...
    def _check_dependencies(self) -> HealthCheck:
        ...
        required_packages = [
            'click', 'rich', 'pydantic', 'networkx', 'jsonschema'
        ]
        
        optional_packages = [
            'openai', 'anthropic', 'psutil'
        ]
