...
class CoqTranslator:
    ...
    def _generate_header(self) -> str:
        ...
        header.extend(
            ["Import ListNotations.", "Open Scope nat_scope.", "Open Scope bool_scope."]
        )
    ...
    def _translate_module(self, module: Module) -> str:
        ...
        if module.assignments:
            ...
            for i, assignment in enumerate(module.assignments):
                ...
                definition = self._translate_assignment_to_definition(
                    assignment, module, def_name
                )
    ...
    def _translate_assignment_to_definition(
        self, assignment: Assignment, module: Module, def_name: str
    ) -> str:
