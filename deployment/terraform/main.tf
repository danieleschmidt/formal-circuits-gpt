# Terraform configuration for formal-circuits-gpt infrastructure
# Multi-cloud deployment with auto-scaling and monitoring
...
terraform {
  ...
  backend "s3" {
    bucket = "formal-circuits-gpt-terraform-state"
    key    = "production/terraform.tfstate"
    region = "us-west-2"
    
    dynamodb_table = "formal-circuits-gpt-terraform-locks"
    encrypt        = true
  }
}
...
variable "domain_name" {
  ...
  type        = string
  default     = "formal-circuits-gpt.com"
}
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description                = "Redis cluster for formal-circuits-gpt"
